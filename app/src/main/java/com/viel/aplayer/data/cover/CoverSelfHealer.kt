...
/**
 * Cover Self Healer (Cover regeneration contract behind CoverRecoveryHelper)
 *
...
interface CoverSelfHealer {
    /**
     * Check And Trigger Cover Regeneration (Non-blocking single-book self-heal)
    ...
    /**
     * Force Regenerate Cover (Rebuild now, bypassing the failed-attempt cache)
