...
class SearchSceneArchitectureTest {
    ...
    fun searchViewModelConsumesSearchSceneDependenciesOnly() {
        ...
        assertTrue(
            ...
            !searchViewModelSource.contains("import com.viel.oto.data.LibraryFacade")
        )
        assertTrue(
    ...
    fun searchModuleDoesNotImportTheBroadFacade() {
        ...
        assertTrue(
            ...
            !searchModuleSource.contains("import com.viel.oto.data.LibraryFacade")
        )
    }
    ...
    fun searchReadModelAndUiExposeSceneSnapshotsInsteadOfRoomRows() {
        ...
        guardedUiFiles.forEach { relativePath ->
            ...
            assertTrue(
                ...
                !source.contains("import com.viel.oto.data.store.SearchHistoryEntry")
            )
        }
    }
