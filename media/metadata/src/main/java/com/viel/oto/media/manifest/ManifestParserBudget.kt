...
/**
 * Caps user-controlled sidecar collections before import state growth.
 *
...
/**
 * Caps user-controlled sidecar metadata strings before they enter import state.
 *
...
/**
 * Normalizes and bounds sidecar strings at parser boundaries.
 *
...
/**
 * Stops accepting sidecar entries before parser state grows without bound.
 *
