...
- `shared/src/main/res/xml/backup_rules.xml` includes only `files/datastore/app_settings.preferences_pb` for legacy Android auto-backup.
- `shared/src/main/res/xml/data_extraction_rules.xml` includes only `files/datastore/app_settings.preferences_pb` for cloud backup and device transfer.
